...
sampled_celltypes = torch.load("saved_files/myDataLiver_0/sampled_celltypes.pt")

# 取得 cell type 對應表
mapping_dict = get_celltype2int_dict("Liver")
...
generated_data = torch.load("saved_files/myDataLiver_0/generated_aggregate_tensor.pt")
