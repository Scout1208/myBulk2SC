...
pbmc.data <- Read10X(data.dir = "/Group16T/common/lcy/dslab_lcy/bulk2sc/B2SC/raw_gene_bc_matrices/hg19/")
...
# 取得標準化數據，確保是普通矩陣
sc_data <- as.matrix(GetAssayData(pbmc, layer = "data"))
...
barcodes <- read.table("/Group16T/common/lcy/dslab_lcy/bulk2sc/B2SC/raw_gene_bc_matrices/hg19/barcodes.tsv", header = TRUE, sep = "\t")
...
# Save as a CSV file
write.table(mapping, file = "/Group16T/common/lcy/dslab_lcy/bulk2sc/B2SC/raw_gene_bc_matrices/hg19/barcode_to_celltype.csv", sep = ",", row.names = FALSE, quote = FALSE)

# Or save as a TSV file
write.table(mapping, file = "/Group16T/common/lcy/dslab_lcy/bulk2sc/B2SC/raw_gene_bc_matrices/hg19/barcode_to_celltype.tsv", sep = "\t", row.names = FALSE, quote = FALSE)
